...
lrDecayScheduler_epochs      = [25]     # List of epochs were decay is applied or None for all epochs
lrDecayScheduler_rate        = 1.5               # Decay rate (new_lr = lr / decay_rate). Usually between 2 and 10.
